    ...
    public virtual float GetHoverDistance(Vector3 worldPosition) {
      ...
      foreach (var collider in _interactionColliders) {
        ...
        if (collider is MeshCollider) {
            ...
            // RESKI-EDIT 2018-11-27 (as part of overall performance update; (primitive) box collider are mush more performant than mesh colliders)
            if (collider.name == "Cuboid_03")
            {
                    /*
                    ...
                    Debug.Log(collider is MeshCollider);
                    Debug.Log("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
                    */
