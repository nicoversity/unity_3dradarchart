...
namespace Leap.Unity.Animation {
  ...
  public class TransformTweenBehaviour : MonoBehaviour {
    ...
    [Header("VRxAR_Edit")]      // vrxar-edit (2018-07-12): edits to the original Script as provided by Leap Motion
    public bool isVisible;      // property indicating if the UI is currently visible or not
    ...
    public void PlayForward() {
      PlayTween(Direction.Forward);
      this.isVisible = true;    // vrxar-edit (2018-07-12): flag UI as visible
    }

    public void PlayBackward() {
      PlayTween(Direction.Backward);
      this.isVisible = false;   // vrxar-edit (2018-07-12): flag UI as hidden
    }
